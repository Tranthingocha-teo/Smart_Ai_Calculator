...
class QuantizationParametersT(object):
    ...
    def __init__(self):
        ...
        self.details = None  # type: Union[None, tflite.CustomQuantization.CustomQuantizationT, tflite.BlockwiseQuantization.BlockwiseQuantizationT, tflite.MultiAxisQuantization.MultiAxisQuantizationT]
