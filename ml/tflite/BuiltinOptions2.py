...
def BuiltinOptions2Creator(unionType, table):
    ...
    if unionType == BuiltinOptions2.StableHLOCompositeOptions:
        ...
        return tflite.StableHLOCompositeOptions.StableHLOCompositeOptionsT.InitFromBuf(table.Bytes, table.Pos)
    if unionType == BuiltinOptions2.StablehloShiftLeftOptions:
        import tflite.StablehloShiftLeftOptions
        return tflite.StablehloShiftLeftOptions.StablehloShiftLeftOptionsT.InitFromBuf(table.Bytes, table.Pos)
    if unionType == BuiltinOptions2.StablehloCaseOptions:
        import tflite.StablehloCaseOptions
        return tflite.StablehloCaseOptions.StablehloCaseOptionsT.InitFromBuf(table.Bytes, table.Pos)
    return None
