...
- **Create an issue**: `gh issue create --title "..." --body "..." -p "Smart AI Calculator Roadmap"`. Always ensure new issues are added to GitHub Project **#1 ("Smart AI Calculator Roadmap")** either via the `-p` flag or by running:
  `gh project item-add 1 --owner Tranthingocha-teo --url "<issue-url>"`
